...
public class DeliveryControllerTest
{
    ...
    public void deliver_failed_max_load_weight()
    {
        ...
        DeliveryOrder deliveryOrder_1 = new DeliveryOrder(supplier, client, norder, products, submissionDate);
    ...
    public void deliver_failed_cannot_deliver_within_a_week()
    {
        ...
        Constraint constraint = new Constraint(localDate.getMonthValue(), shifts);
    ...
    // insert 1000 drivers; order 1000 deliveries; verify different assigned to each delivery;
    ...
    public void deliver_balanced_selection_single_truck()
    {
        ...
        while(norders -- > 0)
        {
            DeliveryOrder deliveryOrder = new DeliveryOrder(supplier, client, norders, products, submissionDate);
...
//            System.out.printf("%s%s\n", currDriver, currDeliveryDate);
    ...
    public void setConstraint()
    {
        ...
        Date availableShift = testObj.GetDriver(driverId).Next();
        assertEquals(7, submissionDate.DifferenceBetweenTwoDates(availableShift));
    }
